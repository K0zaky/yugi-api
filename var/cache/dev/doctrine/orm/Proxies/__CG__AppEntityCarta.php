 ...
 */
class Carta extends \App\Entity\Carta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'codigo', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'precio', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'imagen', '' . "\0" . 'App\\Entity\\Carta' . "\0" . 'idDeck'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carta $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setNombre(?string $nombre): \App\Entity\Carta
    {
     ...
     * {@inheritDoc}
     */
    public function setCodigo(?string $codigo): \App\Entity\Carta
    {
     ...
     * {@inheritDoc}
     */
    public function setPrecio(?float $precio): \App\Entity\Carta
    {
     ...
     * {@inheritDoc}
     */
    public function setImagen(?string $imagen): \App\Entity\Carta
    {
